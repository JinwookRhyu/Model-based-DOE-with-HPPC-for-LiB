...
dir_savefig = "C:/Users/Jinwook/PyCharm_projects/DOE/I_err_" + str(I_err) + "_general_N5_similar_" + str_deg_params_range
dir_txtfile = "C:/Users/Jinwook/PyCharm_projects/DOE/error_bound_optimal_output_D_N3/" + str_deg_params_range
...
for file in glob.glob("*.txt"):
    if "error_bound_CIET_D_50mV" in file:
        ...
        c_c = np.array([0.833, 0.822, 0.610, 0.446, 0.400])
        delta_V = np.array([0.050, -0.200, 0.200, -0.200, 0.200])
...
with open("C:/Users/Jinwook/PyCharm_projects/DOE/general_N5_similar_" + str_deg_params_range + ".pkl", 'wb') as f:
