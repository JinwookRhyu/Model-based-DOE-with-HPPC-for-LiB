...
dir_savefig = "C:/Users/Jinwook/PyCharm_projects/DOE/I_err_" + str(I_err) + "_general_N5_" + str_deg_params_range
...
for file in glob.glob("*.txt"):
    if "error_bound_CIET_D_50mV" in file:
        ...
        c_c = np.array([0.850, 0.850, 0.670, 0.482, 0.431])
        delta_V = np.array([-0.050, -0.200, -0.163, 0.200, -0.200])
...
with open("C:/Users/Jinwook/PyCharm_projects/DOE/general_N5_" + str_deg_params_range + ".pkl", 'wb') as f:
