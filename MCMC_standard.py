...
dir_savefig = "C:/Users/Jinwook/PyCharm_projects/DOE/I_err_" + str(I_err) + "_standard_N5_" + str_deg_params_range
...
with open("C:/Users/Jinwook/PyCharm_projects/DOE/standard_N5_" + str_deg_params_range + ".pkl", 'wb') as f:
