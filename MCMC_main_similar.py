...
dir_savefig = "C:/Users/Jinwook/PyCharm_projects/DOE/I_err_" + str(I_err) + "_optimal_N5_similar_" + str_deg_params_range
dir_txtfile = "C:/Users/Jinwook/PyCharm_projects/DOE/error_bound_optimal_output_D_N5_similar/"
...
for file in glob.glob("*.txt"):
    if "optimized_output_CIET_D_50mV" in file:
        ...
        c_c = np.array([float(i) for i in contents[numpulse - 5].split()[0:N]])
        #c_c = np.repeat(c_c, 2)
        delta_V = np.array([float(i) for i in contents[numpulse - 5].split()[N:2* N]])
...
with open("C:/Users/Jinwook/PyCharm_projects/DOE/optimal_N5_similar_" + str_deg_params_range + ".pkl", 'wb') as f:
